	...
	{ 
		...
		{ 
			...
			if($is_error==0)
				...
				{ echo "<script>alert('Only valid data has been saved successfully');</script>"; }
			...
			<div class="input-group col-md-8 main_div" id="single_answer_option_'.$cnt.'">
			 ...
			 { 
			 	...
			 	$str .= '<div class="input-group col-md-8 main_div" id="multi_answer_'.$cnt.'_'.$i.'_div">
				  <i class="fa fa-arrow-right set_center" aria-hidden="true"></i>
				  <input type="text" name="multi_answer_'.$cnt.'_'.$i.'" id="multi_answer_'.$cnt.'_'.$i.'" class="form-control col-md-4 multi-group_'.$cnt.'" placeholder="Answer" minlength="3" maxlength="150">
